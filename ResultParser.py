...
def get_result_data(text: str):
    return [get_game_count(text),get_invalid_game_count(text),get_goaldiff(text),get_leftgoal(text),get_rightgoal(text), get_avg_point(text),get_left_points(text),get_right_points(text), get_winrate(text), get_expected_winrate(text)]
